...
@section('content')
    ...
    <section class="checkout-section spad">
        <div class="container">
            <form action="{{route('checkout-submit')}}" class="checkout-form">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" id="fir" name="full-name">
                            </div>
                            <div class="col-lg-12">
                                <label for="cun-name">Company Name</label>
                                <input type="text" id="cun-name" name="company-name">
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" id="street" class="street-first" name="street-address">
                                <input type="text">
                            </div>
                            <div class="col-lg-12">
