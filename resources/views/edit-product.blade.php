        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action={{route('edit-product-submit',['product_id'=>$product->ID])}} enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="file" class="imageUpload" name="imageUpload" />
                  </div>
                </div>
                ...
                <div class="form-group last">
                  ...
                  <div class="col-md-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <img src="../../uploads/{{$product->IMAGE}}" alt="hinh anh san pham" class="fileupload-new thumbnail" style="width: 200px; height: 150px;"/>
